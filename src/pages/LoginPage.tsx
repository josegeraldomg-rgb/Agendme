      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        {isLogin && !isForgot && (
          <p className="text-center">
            <button onClick={() => setIsForgot(true)} className="text-xs text-muted-foreground hover:text-primary">
              Esqueci minha senha
            </button>
          </p>
        )}
        ...
        {isForgot && (
          <p className="text-center">
            <button onClick={() => setIsForgot(false)} className="text-xs text-muted-foreground hover:text-primary">
              Voltar ao login
            </button>
          </p>
        )}
